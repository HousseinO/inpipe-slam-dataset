...
"""
Full SLAM node (rewritten):

- PIPE mode:
    IMU + /pipe/odom + ring ICP (laser profiler)
...
class FullSlamNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(
            'Full SLAM node initialized with repeating PIPE/ELBOW and pipe segments anchored at elbow exits.'
        )
